...
#[derive(PartialEq)]
pub(crate) struct ResourceWrapper(ts_opentelemetry_sdk::Resource);

impl From<ts_opentelemetry_sdk::Resource> for ResourceWrapper {
    fn from(r: ts_opentelemetry_sdk::Resource) -> Self {
        ResourceWrapper(r)
    }
}
