...
///
/// ```
/// use ts_opentelemetry_api::{global, trace::{Span, Tracer, TraceContextExt}, Context};
///
...
///
/// ```
/// use ts_opentelemetry_api::{global, trace::{SpanKind, Tracer}};
///
/// let tracer = global::tracer("my-component");
///
...
///
/// ```
/// use ts_opentelemetry_api::{global, trace::{Span, Tracer, mark_span_as_active}};
/// let tracer = global::tracer("my-component");
///
...
///
/// ```no_run
/// # use ts_opentelemetry_api::{global, trace::{Tracer, mark_span_as_active}};
...
/// ```
/// # async fn run() -> Result<(), ()> {
/// use ts_opentelemetry_api::{trace::FutureExt, Context};
...
pub trait Tracer {
    ...
    ///
    /// ```
    /// use ts_opentelemetry_api::{global, trace::{Span, Tracer, get_active_span}, KeyValue};
    ///
    /// fn my_function() {
