...
//!
//! ```
//! use ts_opentelemetry_api::trace::{Tracer, noop::NoopTracerProvider};
...
//!
//! ```
//! use ts_opentelemetry_api::{global, trace::{Span, Tracer, TracerProvider}};
//!
...
//!
//! ```
//! use ts_opentelemetry_api::{global, trace::{self, Span, Status, Tracer, TracerProvider}};
//!
...
//!
//! ```
//! use ts_opentelemetry_api::{global, trace::Tracer};
//!
//! // Get a tracer
//! let tracer = global::tracer("my_tracer");
//!
...
//!
//! ```
//! use ts_opentelemetry_api::{Context, global, trace::{FutureExt, TraceContextExt, Tracer}};
//!
//! async fn some_work() { }
//!
//! // Get a tracer
