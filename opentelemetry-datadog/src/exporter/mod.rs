...
use ts_opentelemetry::sdk::trace::{BatchMessage, Config};
use ts_opentelemetry::sdk::Resource;
use ts_opentelemetry::trace::TraceError;
use ts_opentelemetry::{global, sdk, trace::TracerProvider, KeyValue};
use ts_opentelemetry_http::{HttpClient, ResponseExt};
